CREATE OR ALTER PROCEDURE GiftShop.GetMaxLocationID
    @MaxLocationID TINYINT OUTPUT
AS
/***************************************************************************************************
File: GetMaxLocationID.sql
----------------------------------------------------------------------------------------------------
Create Date:    2021-01-01 (yyyy-mm-dd)
Author:         Sorob Cyrus
Description:    Gets latest Location ID for insert, etc.
Call by:        Add hoc
Steps:          N/A 
****************************************************************************************************
SUMMARY OF CHANGES
