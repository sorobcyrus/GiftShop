CREATE OR ALTER PROCEDURE GiftShop.FindOrderByCustomerID
    @CustomerID INT
AS
/***************************************************************************************************
File: FindOrderByCustomerID.sql
----------------------------------------------------------------------------------------------------
Procedure:      GiftShop.FindOrderByCustomerID
...
Usage:          GiftShop.FindOrderByCustomerID 100001001
****************************************************************************************************
SUMMARY OF CHANGES
...
SELECT OD.OrderID,
    ...
    EM.Title AS EmployeeTitle,          -- I guess we won't make this a calculated field since we don't want business rules on the Database side?
